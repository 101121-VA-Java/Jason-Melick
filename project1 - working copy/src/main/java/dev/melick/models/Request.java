...
public class Request {
    ...
    @SequenceGenerator(name = "requestGenerator", sequenceName = "requests_req_id_seq", allocationSize = 1)
    @Column(name = "att_id")
    ...
    @Column(name = "why_benco_upgrade")
    private String whyBencoUpgrade;

    @Column(name = "emp_reject")
