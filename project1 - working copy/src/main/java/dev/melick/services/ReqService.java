...
import dev.melick.repositories.hibernate.RequestHibernateRepo;
...
public class ReqService {
    ...
    private static RequestHibernateRepo rhr = new RequestHibernateRepo();
    ...
    public void createRequest(Request newRequest) {
        ...
        System.out.println("in service before adding" + newRequest);
    ...
    public void bencoDecision(Request r){
        ...
        if(r.isBencoUpgrade() || r.isBencoDowngrade()){
            rr.updateAmt(r);
        }
