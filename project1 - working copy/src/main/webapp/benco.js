            ...
            async function decide(){
                ...
                if(adjAmt != null && adjAmt != ''){
                    ...
                    if(newAmt > prevAmt){
                        ...
                        thisRequest.finalAmt = adjAmt;
                        thisRequest.bencoUpgrade = true;
                        thisRequest.bencoDowngrade = false;
                        ...
                        thisRequest.bencoUpgrade = false;
                        thisRequest.whyBencoUpgrade = 'Downgraded by BenCo.';
                        thisRequest.bencoAppBy = empInfo.empId;
                    }
                }
                console.log('Final amt after benco adjustment' + thisRequest.finalAmt);
                if (decide == 'true'){
